            ...
            <div class="newsletter-signup widget widget-newsletter-signup">
                ...
                <div class="text-box">
                    ...
                    <div class="text-box-inner">
                        ...
                        <p>Follow EarthLab</p>
                        <div class="social-icon-box"><a class="social-icon" aria-label="Facebook" href="https://www.facebook.com/UWEarthLab/"><i class="fa fa-facebook"></i></a> <a class="social-icon" aria-label="Twitter" href="https://twitter.com/uwearthlab"><i class="fa fa-twitter"></i></a>
                        <a class="social-icon" aria-label="Instagram" href="https://www.instagram.com/uwearthlab"><i class="fa fa-instagram"></i></a><a class="social-icon" aria-label="LinkedIn" href="https://www.linkedin.com/company/uwearthlab"><i class="fa fa-linkedin"></i></a></div>
