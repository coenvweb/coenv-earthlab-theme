                        ...
                        <div class="logo-headers row">
                            <div class="left-college medium-3 columns small-12">
                               <div class="site-footer__header">
                                ...
                                <div class="social-icon-box right"><a class="social-icon" aria-label="Facebook" href="https://www.facebook.com/UWEarthLab/"><i class="fa fa-facebook"></i></a> <a class="social-icon" aria-label="Twitter" href="https://twitter.com/uwearthlab"><i class="fa fa-twitter"></i></a><a class="social-icon" aria-label="Instagram" href="https://www.instagram.com/uwearthlab"><i class="fa fa-instagram"></i></a><a class="social-icon" aria-label="LinkedIn"` href="https://www.linkedin.com/company/uwearthlab"><i class="fa fa-linkedin"></i></a></div>
                                <?php if (is_user_logged_in()) { ?>
                                    <p><a href="<?php echo wp_logout_url( home_url() ); ?>" title="Logout">Log out</a></p>
                                <?php } else { ?>
                                    <p><a href="<?php echo wp_login_url(); ?>" title="Staff Login">Staff login</a></p>
                                <?php } ?>
                    ...
                    <div class="uw-footer">
                        <div class="layout-container row medium-collapse">
                            ...
                            <div class="be-boundless">
                                ...
                                <a href="http://www.washington.edu/boundless/" rel="home" title="University of Washington - Be Boundless" target="_blank"><img class="boundless-logo" src='<?= get_template_directory_uri() ?>/assets/images/boundless_logo.png' alt="University of Washington - Be Boundless" /><span class="hide">Be Boundless</span></a>
                            </div>
